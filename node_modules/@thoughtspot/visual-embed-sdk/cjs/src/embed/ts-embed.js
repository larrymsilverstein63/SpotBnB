...
class TsEmbed {
    ...
    async getDefaultAppInitData() {
        ...
        const baseInitData = {
            ...
            ...(0, utils_1.getHostEventsConfig)(this.viewConfig),
        };
        return baseInitData;
    }
    ...
    getBaseQueryParams(queryParams = {}) {
        ...
        queryParams[types_1.Param.Version] = sdk_version_1.version;
        ...
        if (overrideHistoryState !== undefined) {
            queryParams[types_1.Param.OverrideHistoryState] = overrideHistoryState;
        }
    ...
    resolvePreRenderContainerTarget() {
        ...
        if (typeof containerConfig === 'string') {
            try {
                ...
                container = (0, utils_1.querySelectorAcrossShadowRoot)(containerConfig, this.hostElement);
            }
            catch (e) {
                logger_1.logger.error(`Invalid CSS selector for preRenderContainer: ${containerConfig}`, e);
            }
        }
        ...
        return this.hostEventClient.triggerHostEvent(messageType, data, context).catch((err) => {
            ...
            if (err === null || err === void 0 ? void 0 : err.isValidationError) {
                const errorDetails = (_a = err.embedErrorDetails) !== null && _a !== void 0 ? _a : {
                    errorType: types_1.ErrorDetailsTypes.VALIDATION_ERROR,
                    message: err.message || errors_1.ERROR_MESSAGE.UPDATEFILTERS_INVALID_PAYLOAD,
                    code: types_1.EmbedErrorCodes.UPDATEFILTERS_INVALID_PAYLOAD,
                    error: err.message,
                };
    ...
    subscribedEvent(eventName) {
        return `${eventName} ${types_1.EmbedEvent.Subscribed}`;
    }
    /**
            ...
            if (!(0, embedConfig_1.getEmbedConfig)().waitForCleanupOnDestroy) {
                ...
                Promise.race([
                    ...
                    try {
                        ...
                        logger_1.logger.log('Error removing DOM element on destroy', e);
                    }
                });
            }
        }
