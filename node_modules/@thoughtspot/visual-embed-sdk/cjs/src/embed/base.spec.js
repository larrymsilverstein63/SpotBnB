...
const processTrigger = tslib_1.__importStar(require("../utils/processTrigger"));
...
describe('Base TS Embed', () => {
    ...
    test('Should show an alert when third party cookie access is blocked', () => {
        ...
        authEE.on(auth.AuthStatus.FAILURE, (reason) => {
            ...
            expect(window.alert).toHaveBeenCalledWith('Third-party cookie access is blocked on this browser. Please allow third-party cookies for this to work properly. \nYou can use `suppressNoCookieAccessAlert` to suppress this message.');
        });
    });
    ...
    test('should call reload with the provided iframe', () => {
        ...
        // Act
        (0, base_1.reloadIframe)(iFrameElement);
        // Assert
        expect(spyReload).toHaveBeenCalledWith(iFrameElement);
    });
    test('should warn when called without an iframe element', () => {
        // Arrange
        const warnSpy = jest.spyOn(logger_1.logger, 'warn').mockImplementation(() => { });
        // Act
        base_1.reloadIframe(undefined);
        // Assert
...
describe('Init Promise Functions', () => {
    describe('SSR environment handling', () => {
        ...
        test('createAndSetInitPromise should log error in SSR environment', () => {
            ...
            (0, base_1.createAndSetInitPromise)();
    ...
    test('getIsInitCalled should return false before init is called', () => {
        expect((0, base_1.getIsInitCalled)()).toBe(false);
    });
    ...
    test('createAndSetInitPromise should not override existing promise if ignoreIfAlreadyExists', () => {
        const firstPromise = (0, base_1.getInitPromise)();
        (0, base_1.createAndSetInitPromise)();
        const secondPromise = (0, base_1.getInitPromise)();
    ...
    test('getIsInitCompleted returns false (not undefined) before init resolves', () => {
        ...
        const result = (0, base_1.getIsInitCompleted)();
