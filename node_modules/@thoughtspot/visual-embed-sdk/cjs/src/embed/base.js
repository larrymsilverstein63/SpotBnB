...
exports.reloadIframe = exports.reset = exports.exportTML = exports.executeTML = exports.renderInQueue = exports.logout = exports.disableAutoLogin = exports.init = exports.getIsInitCalled = exports.getIsInitCompleted = exports.getInitPromise = exports.createAndSetInitPromise = exports.prefetch = exports.handleAuth = exports.notifyLogout = exports.notifyAuthSuccess = exports.notifyAuthSDKSuccess = exports.notifyAuthFailure = exports.getAuthPromise = exports.authPromise = void 0;
...
const createAndSetInitPromise = () => {
    ...
    initPromise.finally(() => {
        const curVal = (0, utils_1.getValueFromWindow)(initFlagKey);
        if (!curVal) {
            logger_1.logger.error('initFlagStore missing when marking init complete');
            return;
        }
        curVal.isInitCompleted = true;
        (0, utils_1.storeValueInWindow)(initFlagKey, curVal);
    });
};
...
const getIsInitCompleted = () => { var _a; return !!((_a = (0, utils_1.getValueFromWindow)(initFlagKey)) === null || _a === void 0 ? void 0 : _a.isInitCompleted); };
exports.getIsInitCompleted = getIsInitCompleted;
