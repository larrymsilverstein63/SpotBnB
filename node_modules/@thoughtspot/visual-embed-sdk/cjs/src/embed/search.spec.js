...
describe('Search embed tests', () => {
    ...
    test('should set isThisPeriodInDateFiltersEnabled to true in url', async () => {
        ...
        searchEmbed.render();
        await (0, test_utils_1.executeAfterWait)(() => {
            (0, test_utils_1.expectUrlMatchesWithParams)((0, test_utils_1.getIFrameSrc)(), `http://${thoughtSpotHost}/v2/?${defaultParamsWithHiddenActions}&dataSourceMode=expand&enableDataPanelV2=true&useLastSelectedSources=false&isThisPeriodInDateFiltersEnabled=true${prefixParams}#/embed/saved-answer/${answerId}`);
        });
    });
    test('Should add newChartsLibrary flag set to true to the iframe src', async () => {
        ...
        searchEmbed.render();
        await (0, test_utils_1.executeAfterWait)(() => {
            (0, test_utils_1.expectUrlMatchesWithParams)((0, test_utils_1.getIFrameSrc)(), `http://${thoughtSpotHost}/v2/?${defaultParamsWithHiddenActions}&enableDataPanelV2=true&muzeChartPhase1EnabledGA=true&dataSourceMode=expand&useLastSelectedSources=false${prefixParams}#/embed/answer`);
        });
    });
    test('Should add newChartsLibrary flag set to false to the iframe src', async () => {
        ...
        searchEmbed.render();
        await (0, test_utils_1.executeAfterWait)(() => {
            (0, test_utils_1.expectUrlMatchesWithParams)((0, test_utils_1.getIFrameSrc)(), `http://${thoughtSpotHost}/v2/?${defaultParamsWithHiddenActions}&enableDataPanelV2=true&muzeChartPhase1EnabledGA=false&dataSourceMode=expand&useLastSelectedSources=false${prefixParams}#/embed/answer`);
        });
    });
...
describe('SearchEmbed visualOverrides tests', () => {
    test('should pass visualOverrides in embedParams when visualOverrides config is provided', async () => {
        ...
        await (0, test_utils_1.testVisualOverridesInEmbed)(searchEmbed, visualOverrides);
    });
