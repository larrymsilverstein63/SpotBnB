...
exports.setParamIfDefined = exports.validateHttpUrl = exports.isWindowUndefined = exports.getHostEventsConfig = exports.formatTemplate = exports.calculateVisibleElementData = exports.getEffectiveClippingAncestors = exports.getClippingAncestors = exports.getScrollableAncestors = exports.handleExitPresentMode = exports.handlePresentEvent = exports.resetValueFromWindow = exports.arrayIncludesString = exports.getValueFromWindow = exports.storeValueInWindow = exports.getTypeFromValue = exports.isUndefined = exports.removeStyleProperties = exports.setStyleProperties = exports.removeTypename = exports.getOperationNameFromQuery = exports.deepMerge = exports.querySelectorAcrossShadowRoot = exports.getDOMNode = exports.getRuntimeFilters = exports.getCustomisations = exports.checkReleaseVersionInBeta = exports.setAttributes = exports.embedEventStatus = exports.getOffsetTop = exports.getEncodedQueryParamsString = exports.getRedirectUrl = exports.appendToUrlHash = exports.getSSOMarker = exports.isValidCssMargin = exports.getCssDimension = exports.getQueryParamString = exports.getRuntimeParameters = exports.getFilterQuery = void 0;
...
exports.querySelectorAcrossShadowRoot = querySelectorAcrossShadowRoot;
const deepMerge = (target, source) => (0, ts_deepmerge_1.merge)(target, source);
...
const hasMatchingOverflow = (element, overflowPattern) => {
...
const getClippingAncestors = (element) => {
    const ancestors = [];
    if (!element) {
        return ancestors;
    }
...
exports.getClippingAncestors = getClippingAncestors;
const getIntersectedRect = (rect, clipRect) => ({
...
const isSameVisibleRect = (rectA, rectB) => rectA.top === rectB.top
    && rectA.left === rectB.left
    && rectA.bottom === rectB.bottom
    && rectA.right === rectB.right;
const getEffectiveClippingAncestors = (element) => {
    if (!element) {
        return [];
    }
    ...
    return (0, exports.getClippingAncestors)(element).filter((ancestor) => {
...
exports.getEffectiveClippingAncestors = getEffectiveClippingAncestors;
const calculateVisibleElementData = (element, useClippingAncestors = false) => {
    if (!element) {
        return {
            top: 0,
            height: 0,
    ...
    if (useClippingAncestors) {
        (0, exports.getEffectiveClippingAncestors)(element).forEach((ancestor) => {
