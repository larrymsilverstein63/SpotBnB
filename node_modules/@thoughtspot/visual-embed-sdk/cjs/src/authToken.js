...
exports.resetCachedAuthToken = exports.validateAuthToken = exports.getAuthenticationToken = exports.storeAuthTokenInCache = exports.getCacheAuthToken = void 0;
...
exports.getCacheAuthToken = getCacheAuthToken;
const storeAuthTokenInCache = (token) => {
    (0, utils_1.storeValueInWindow)(cacheAuthTokenKey, token);
};
exports.storeAuthTokenInCache = storeAuthTokenInCache;
...
async function getAuthenticationToken(embedConfig, skipvalidation = false) {
    const cachedAuthToken = (0, exports.getCacheAuthToken)();
    ...
    (0, exports.storeAuthTokenInCache)(authToken);
    return authToken;
}
...
const resetCachedAuthToken = () => {
    (0, exports.storeAuthTokenInCache)(null);
};
