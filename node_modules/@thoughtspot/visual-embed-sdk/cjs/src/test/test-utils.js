...
exports.testVisualOverridesInEmbed = exports.mockSessionInfo = exports.getHashQueryParams = exports.createRootEleForEmbed = exports.expectUrlMatch = exports.expectUrlToHaveParamsWithValues = exports.expectUrlMatchesWithParams = exports.mockMessageChannel = exports.messageChannelMock = exports.fixedEncodeURI = exports.EVENT_WAIT_TIME = exports.executeAfterWait = exports.postMessageToParent = exports.waitFor = exports.getIFrameSrc = exports.getAllIframeEl = exports.getIFrameEl = exports.getRootEl2 = exports.getRootEl = exports.getDocumentBody = exports.defaultParamsForPinboardEmbed = exports.defaultParams = exports.defaultParamsWithoutHiddenActions = void 0;
...
const testVisualOverridesInEmbed = async (embed, visualOverrides) => {
    ...
    await (0, exports.executeAfterWait)(() => {
        const iframe = (0, exports.getIFrameEl)();
        (0, exports.postMessageToParent)(iframe.contentWindow, mockEmbedEventPayload, mockPort);
    });
    await (0, exports.executeAfterWait)(() => {
...
exports.testVisualOverridesInEmbed = testVisualOverridesInEmbed;
