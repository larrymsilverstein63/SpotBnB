...
const answer_queries_1 = require("./answer-queries");
const queries = tslib_1.__importStar(require("./answer-queries"));
const authTokenInstance = tslib_1.__importStar(require("../../../authToken"));
const tokenizedFetch = tslib_1.__importStar(require("../../../tokenizedFetch"));
...
function createAnswerService(answer = {}, point) {
    return new answerService_1.AnswerService(defaultSession, answer, 'https://tshost', point);
}
describe('Answer service tests', () => {
    ...
    test('fetchData should call the right graphql, and return data', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=GetTableWithHeadlineData', expect.objectContaining({
            body: JSON.stringify({
                ...
                query: answer_queries_1.getAnswerData,
                variables: {
                    session: defaultSession,
                    deadline: 0,
    ...
    test('fetchCSVBlob should call the right API', () => {
        ...
        expect(mockTokenizedFetch).toHaveBeenCalledWith(`https://tshost/prism/download/answer/csv?sessionId=${defaultSession.sessionId}&genNo=${defaultSession.genNo}&userLocale=en-us&exportFileName=data&hideCsvHeader=false`, expect.objectContaining({}));
        answerService.fetchCSVBlob('en-uk', true);
        expect(mockTokenizedFetch).toHaveBeenCalledWith(`https://tshost/prism/download/answer/csv?sessionId=${defaultSession.sessionId}&genNo=${defaultSession.genNo}&userLocale=en-uk&exportFileName=data&hideCsvHeader=false`, expect.objectContaining({}));
        answerService.fetchCSVBlob(undefined, false);
        expect(mockTokenizedFetch).toHaveBeenCalledWith(`https://tshost/prism/download/answer/csv?sessionId=${defaultSession.sessionId}&genNo=${defaultSession.genNo}&userLocale=en-us&exportFileName=data&hideCsvHeader=true`, expect.objectContaining({}));
    });
    ...
    test('getUnderlyingDataForPoint should call the right APIs', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=RemoveColumns', expect.objectContaining({
            body: JSON.stringify({
                ...
                query: answer_queries_1.removeColumns,
                variables: {
                    session: {
                        ...defaultSession,
                        genNo: 2,
    ...
    test.each([
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=GetUnAggregatedAnswerSession', expect.objectContaining({
            body: JSON.stringify({
    ...
    test('addFilter should call the right API', async () => {
        ...
        const session = await answerService.addFilter('col1', types_1.RuntimeFilterOp.IN, [2]);
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=AddUpdateFilter', expect.objectContaining({
            body: JSON.stringify({
                operationName: 'AddUpdateFilter',
                query: answer_queries_1.addFilter,
                variables: {
                    session: defaultSession,
                    params: {
                        filterContent: [{
    ...
    test('Should fetch answer if not passed', async () => {
        ...
        const answerService = new answerService_1.AnswerService(defaultSession, null, 'https://tshost');
    ...
    test('Add columns by name should call the right API', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=AddColumns', expect.objectContaining({
            body: JSON.stringify({
                operationName: 'AddColumns',
                query: answer_queries_1.addColumns,
                variables: {
                    session: defaultSession,
                    columns: [{
                            logicalColumnId: 'id1',
    ...
    test('Get SQL query should call the right API', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=GetSQLQuery', expect.objectContaining({
            body: JSON.stringify({
                operationName: 'GetSQLQuery',
                query: answer_queries_1.getSQLQuery,
                variables: {
                    session: defaultSession,
                },
            }),
    ...
    test('Get SQL query with all columns should update display mode', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=UpdateDisplayMode', expect.objectContaining({
            body: JSON.stringify({
    ...
    test('Add displayed Viz should call the right API', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=AddVizToLiveboard', expect.objectContaining({
            body: JSON.stringify({
    ...
    test('GetTML should call the right API', async () => {
        ...
        expect(fetchMock).toHaveBeenCalledWith('https://tshost/prism/?op=GetUnsavedAnswerTML', expect.objectContaining({
            body: JSON.stringify({
