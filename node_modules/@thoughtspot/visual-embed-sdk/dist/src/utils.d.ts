 ...
 */
export declare function querySelectorAcrossShadowRoot(selector: string, referenceNode?: Node | null): Element | null;
...
export declare const getScrollableAncestors: (element: HTMLElement) => HTMLElement[];
export declare const getClippingAncestors: (element: HTMLElement) => HTMLElement[];
export declare const getEffectiveClippingAncestors: (element: HTMLElement) => HTMLElement[];
export declare const calculateVisibleElementData: (element: HTMLElement, useClippingAncestors?: boolean) => {
    top: number;
    height: number;
    left: number;
    width: number;
