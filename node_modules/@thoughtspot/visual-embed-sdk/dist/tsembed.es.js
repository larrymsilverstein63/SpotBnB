...
const createAndSetInitPromise = () => {
    ...
    initPromise.finally(() => {
        ...
        if (!curVal) {
            logger$3.error('initFlagStore missing when marking init complete');
            return;
        }
...
class TsEmbed {
    ...
    constructor(domSelector, viewConfig) {
        ...
        const afterInit = () => {
            ...
            if (!this.embedConfig) {
                logger$3.error('embedConfig unavailable in afterInit; init() may not have completed');
                return;
            }
        ...
        if (!this.shouldWaitForRenderPromise) {
            ...
            this.isReadyForRenderPromise = getInitPromise()
                .then(afterInit)
                .catch((err) => {
                logger$3.error('SDK init failed before embed could be configured', err);
                this.throwInitError();
            })
                .finally(() => {
