...
import { executeAfterWait, getDocumentBody, getIFrameSrc, getRootEl, defaultParams, defaultParamsWithoutHiddenActions, expectUrlMatchesWithParams, expectUrlToHaveParamsWithValues, postMessageToParent, getIFrameEl, mockMessageChannel, waitFor, } from '../test/test-utils';
...
describe('Liveboard/viz embed tests', () => {
    ...
    test('should render liveboard with data panel v2 flag set to false by default', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&enableDataPanelV2=true#/embed/viz/${liveboardId}`);
        });
    });
    test('should set disabled actions using PersonalizedViewsDropdown alias', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true&${defaultParamsWithoutHiddenActions}&disableAction=[%22${Action.PersonalisedViewsDropdown}%22]&disableHint=Action%20denied&hideAction=[%22${Action.ReportError}%22]${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set hidden actions using OrganizeFavorites alias', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true&${defaultParamsWithoutHiddenActions}&hideAction=[%22${Action.ReportError}%22,%22${Action.OrganiseFavourites}%22]${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('should set isThisPeriodInDateFiltersEnabled to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isThisPeriodInDateFiltersEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isLiveboardPermissionV2Enabled to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLiveboardPermissionV2Enabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isPNGInScheduledEmailsEnabled to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isPNGInScheduledEmailsEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isWYSIWYGLiveboardPDFEnabled to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isWYSIWYGLiveboardPDFEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should disable isWYSIWYGLiveboardPDFEnabled by default in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isWYSIWYGLiveboardPDFEnabled=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isLiveboardXLSXCSVDownloadEnabled to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLiveboardXLSXCSVDownloadEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isLiveboardXLSXCSVDownloadEnabled to false in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLiveboardXLSXCSVDownloadEnabled=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isGranularXLSXCSVSchedulesEnabled to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isGranularXLSXCSVSchedulesEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isGranularXLSXCSVSchedulesEnabled to false in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isGranularXLSXCSVSchedulesEnabled=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isLinkParametersEnabled to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLinkParametersEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set isLinkParametersEnabled to false in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLinkParametersEnabled=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('should set enableLiveboardDataCache to true in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&enableLiveboardDataCache=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should set enableLiveboardDataCache to false in url', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&enableLiveboardDataCache=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('Should add showMaskedFilterChip flag set to true to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&showMaskedFilterChip=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('Should add showMaskedFilterChip flag set to false to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&showMaskedFilterChip=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('Should add isLiveboardMasterpiecesEnabled flag set to true to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLiveboardMasterpiecesEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('Should add isLiveboardMasterpiecesEnabled flag set to false to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isLiveboardMasterpiecesEnabled=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('Should add newChartsLibrary flag set to true to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&muzeChartPhase1EnabledGA=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('Should add newChartsLibrary flag set to false to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&muzeChartPhase1EnabledGA=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('should add isCentralizedLiveboardFilterUXEnabled flag and set value to true to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isCentralizedLiveboardFilterUXEnabled=true${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    test('should add isCentralizedLiveboardFilterUXEnabled flag and set value to false to the iframe src', async () => {
        ...
        liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}&isCentralizedLiveboardFilterUXEnabled=false${prefixParams}#/embed/viz/${liveboardId}`);
        });
    });
    ...
    describe('personalizedViewId functionality', () => {
        ...
        test('should render liveboard with personalizedViewId and activeTabId together', async () => {
            ...
            await executeAfterWait(() => {
                ...
                expect(getIFrameSrc()).toMatch(new RegExp(`#/embed/viz/${liveboardId}/tab/${activeTabId}\\?view=${personalizedViewId}`));
            });
        });
        test('should render liveboard with personalizedViewId and vizId together', async () => {
            ...
            await executeAfterWait(() => {
                ...
                expect(getIFrameSrc()).toMatch(new RegExp(`#/embed/viz/${liveboardId}/${vizId}\\?view=${personalizedViewId}`));
            });
        });
        test('should render liveboard with personalizedViewId, activeTabId, and vizId together', async () => {
            ...
            await executeAfterWait(() => {
                ...
                expect(getIFrameSrc()).toMatch(new RegExp(`#/embed/viz/${liveboardId}/tab/${activeTabId}/${vizId}\\?view=${personalizedViewId}`));
            });
        });
        ...
        describe('backward compatibility with liveboardId?view= workaround', () => {
            ...
            test('should extract view from workaround and add at end of URL', async () => {
                ...
                await executeAfterWait(() => {
                    ...
                    expect(getIFrameSrc()).toMatch(new RegExp(`#/embed/viz/${liveboardId}\\?view=${workaroundViewId}`));
                });
            });
            test('should extract view and place after tab when activeTabId is provided', async () => {
                ...
                await executeAfterWait(() => {
                    ...
                    expect(getIFrameSrc()).toMatch(new RegExp(`#/embed/viz/${liveboardId}/tab/${activeTabId}\\?view=${workaroundViewId}`));
                });
            });
            test('should use personalizedViewId over workaround when both provided', async () => {
                ...
                await executeAfterWait(() => {
                    ...
                    expect(getIFrameSrc()).toMatch(new RegExp(`#/embed/viz/${liveboardId}\\?view=${personalizedViewId}`));
                });
            });
        });
    });
    ...
    test('should set runtime parametere values in url params', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&param1=Integer%20Date%20Range&paramVal1=1#/embed/viz/${liveboardId}`);
        });
    });
    test('should set showSpotterLimitations parameter in url params', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&showSpotterLimitations=true#/embed/viz/${liveboardId}`);
        });
    });
    test('should set spotterFileUploadEnabled parameter in url params', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&spotterFileUploadEnabled=true#/embed/viz/${liveboardId}`);
        });
    });
    test('should set enableStarterPrompts parameter in url params', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&enableStarterPrompts=true#/embed/viz/${liveboardId}`);
        });
    });
    ...
    test('should render the liveboard embed with updatedSpotterChatPrompt', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&updatedSpotterChatPrompt=true#/embed/viz/${liveboardId}`);
        });
    });
    test('should render the liveboard embed with updatedSpotterChatPrompt disabled', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&updatedSpotterChatPrompt=false#/embed/viz/${liveboardId}`);
        });
    });
    test('should set hideToolResponseCardBranding parameter in url params via spotterChatConfig', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&hideToolResponseCardBranding=true#/embed/viz/${liveboardId}`);
        });
    });
    test('should set toolResponseCardBrandingLabel parameter in url params via spotterChatConfig', async () => {
        ...
        await liveboardEmbed.render();
        await executeAfterWait(() => {
            expectUrlMatchesWithParams(getIFrameSrc(), `http://${thoughtSpotHost}/?embedApp=true${defaultParams}${prefixParams}&toolResponseCardBrandingLabel=MyBrand#/embed/viz/${liveboardId}`);
        });
    });
    ...
    describe('PreRender flow for liveboard embed', () => {
        ...
        test('it should navigateToLiveboard with liveboard id is not passed with EmbedListenerReady event', async () => {
            ...
            await executeAfterWait(() => {
                const iFrame = document.getElementById(libEmbed.getPreRenderIds().child);
                // should render the generic link
                expect(navigateToLiveboardSpy).toHaveBeenCalledWith(testLiveboardId, 'testVizId', 'testActiveTabId', undefined);
                expect(iFrame.src).toMatch(/http:\/\/tshost\/.*&isLiveboardEmbed=true.*#$/);
                expect(consoleSpy).toHaveBeenCalledTimes(0);
            });
        });
        ...
        test('should replace existing preRender when replaceExistingPreRender is true', async () => {
            ...
            await waitFor(() => { var _a; return ((_a = document.getElementById(ids.wrapper)) === null || _a === void 0 ? void 0 : _a[tsKey]) === embedB; });
    ...
    describe('Liveboard Embed Container Loading and PreRender', () => {
        ...
        test('should call navigateToLiveboard after embed container is loaded in beforePrerenderVisible', async () => {
            ...
            expect(navigateToLiveboardSpy).toHaveBeenCalledWith(liveboardId, vizId, activeTabId, undefined);
        });
        ...
        test('should work with all liveboard parameters', async () => {
            ...
            expect(navigateToLiveboardSpy).toHaveBeenCalledWith(customLiveboardId, customVizId, customActiveTabId, undefined);
        });
        test('should work with minimal liveboard parameters', async () => {
            ...
            expect(navigateToLiveboardSpy).toHaveBeenCalledWith(liveboardId, undefined, undefined, undefined);
        });
    });
