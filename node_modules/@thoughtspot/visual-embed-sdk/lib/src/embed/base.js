...
export const getIsInitCompleted = () => { var _a; return !!((_a = getValueFromWindow(initFlagKey)) === null || _a === void 0 ? void 0 : _a.isInitCompleted); };
 ...
 * @group Global methods
 */
export const reloadIframe = (iFrame) => {
    if (!iFrame) {
