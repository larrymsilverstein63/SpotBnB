...
import { Action, AuthType, EmbedEvent, InterceptedApiType, Param } from '../types';
import { init } from '../index';
import * as authInstance from '../auth';
import { TsEmbed } from './ts-embed';
import { LiveboardEmbed } from './liveboard';
import { getDocumentBody, getRootEl, postMessageToParent, } from '../test/test-utils';
...
describe('startAutoMCPFrameRenderer', () => {
    ...
    beforeEach(() => {
        ...
        getEmbedBasePathSpy = jest.spyOn(TsEmbed.prototype, 'getEmbedBasePath').mockImplementation(function (query) {
            return `http://${thoughtSpotHost}/${query}#`;
        });
        renderIFrameSpy = jest.spyOn(TsEmbed.prototype, 'renderIFrame').mockResolvedValue(undefined);
    });
    afterEach(() => {
    ...
    async function captureRenderedSrc(viewConfig = {}) {
        let capturedSrc = '';
        renderIFrameSpy.mockRestore();
        renderIFrameSpy = jest.spyOn(TsEmbed.prototype, 'renderIFrame')
    ...
    describe('frameParams forwarding', () => {
        test('frameParams.height and .width applied to the replacement iframe element', async () => {
            ...
            const createIframeElSpy = jest.spyOn(TsEmbed.prototype, 'createIframeEl');
