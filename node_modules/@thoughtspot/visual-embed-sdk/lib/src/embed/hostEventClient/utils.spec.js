import { isValidUpdateFiltersPayload, isValidUpdateParametersPayload, isValidDrillDownPayload, createValidationError, throwUpdateFiltersValidationError, throwUpdateParametersValidationError, throwDrillDownValidationError, } from './utils';
...
describe('hostEventClient utils', () => {
    ...
    describe('isValidUpdateFiltersPayload', () => {
        ...
        it('returns false for empty filters array', () => {
            expect(isValidUpdateFiltersPayload({ filters: [] })).toBe(false);
        });
    ...
    describe('isValidDrillDownPayload', () => {
        ...
        it('returns false for empty points object', () => {
            expect(isValidDrillDownPayload({ points: {} })).toBe(false);
        });
        it('returns false for non-object points', () => {
            expect(isValidDrillDownPayload({ points: 'invalid' })).toBe(false);
        });
