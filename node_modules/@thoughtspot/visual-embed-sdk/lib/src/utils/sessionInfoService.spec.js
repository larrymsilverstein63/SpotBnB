...
import { formatPreauthInfo, getPreauthInfo, getSessionInfo, resetCachedPreauthInfo, resetCachedSessionInfo, getCachedSessionInfo, getSessionDetails, } from './sessionInfoService';
describe('sessionInfoService', () => {
    ...
    describe('getPreauthInfo', () => {
        it('fetches and caches preauthInfo on first call', async () => {
            ...
            jest.spyOn(embedConfigModule, 'getEmbedConfig').mockReturnValue({ thoughtSpotHost: 'https://ts' });
            jest.spyOn(authServiceModule, 'fetchPreauthInfoService').mockResolvedValue(mockResp);
        ...
        it('returns cached preauthInfo on subsequent calls (covers allowCache=true && preauthInfo cached branch)', async () => {
            ...
            jest.spyOn(embedConfigModule, 'getEmbedConfig').mockReturnValue({ thoughtSpotHost: 'https://ts' });
            const fetchSpy = jest.spyOn(authServiceModule, 'fetchPreauthInfoService').mockResolvedValue(mockResp);
    ...
    describe('getSessionInfo', () => {
        it('fetches and returns session info', async () => {
            ...
            jest.spyOn(embedConfigModule, 'getEmbedConfig').mockReturnValue({ thoughtSpotHost: 'https://ts' });
            jest.spyOn(authServiceModule, 'fetchSessionInfoService').mockResolvedValue(sessionInfoResp);
        ...
        it('returns cached session info on second call', async () => {
            ...
            jest.spyOn(embedConfigModule, 'getEmbedConfig').mockReturnValue({ thoughtSpotHost: 'https://ts' });
            const fetchSpy = jest.spyOn(authServiceModule, 'fetchSessionInfoService').mockResolvedValue(sessionInfoResp);
...
//# sourceMappingURL=sessionInfoService.spec.js.map