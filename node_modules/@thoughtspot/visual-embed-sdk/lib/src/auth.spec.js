...
describe('Unit test for auth', () => {
    ...
    test('doCookielessTokenAuth: when authEndpoint and getAuthToken are not there, it throw error', async () => {
        try {
            await authInstance.doCookielessTokenAuth(embedConfig.doTokenAuthFailureWithoutAuthEndPoint);
        }
        catch (e) {
    ...
    it('authenticate: when authType is None', async () => {
        expect(await authInstance.authenticate(embedConfig.nonAuthSucess)).not.toBeInstanceOf(Error);
    });
