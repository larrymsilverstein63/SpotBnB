...
export const getIFrameEl = (container = document) => container.querySelector('iframe');
 ...
 */
export const executeAfterWait = (fn, waitTime = 0) => new Promise((resolve, reject) => {
    setTimeout(() => {
        const value = fn();
        resolve(value);
    }, waitTime);
...
export const expectUrlToHaveParamsWithValues = (url, paramsWithValues) => {
...
export const expectUrlMatch = (source, target) => {
...
export const getHashQueryParams = (hash) => {
...
export const testVisualOverridesInEmbed = async (embed, visualOverrides) => {
