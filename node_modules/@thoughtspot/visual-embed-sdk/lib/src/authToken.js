...
export const getCacheAuthToken = () => getValueFromWindow(cacheAuthTokenKey);
export const storeAuthTokenInCache = (token) => {
 ...
 * @param embedConfig
 */
export async function getAuthenticationToken(embedConfig, skipvalidation = false) {
...
export const validateAuthToken = async (embedConfig, authToken, suppressAlert) => {
